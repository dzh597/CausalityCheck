...
2.  **Execute Replacement**:
    ...
    *   **Full-text replacement**: Replace **all** occurrences of the original name and abbreviation throughout the JSON data with the new fictional name and abbreviation. This includes all text fields such as `context`, `question`, `choices`, `causal_chain`, etc.
...
"answer": 3,
"causal_chain": "surge in interest in SC → increased media coverage → criticism for hype and inaccuracies → greater responsibility on media to report accurately",
"correctness": 1
}
"""
