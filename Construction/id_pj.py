...
- **Sole Modification**: You may only modify the `context` field by inserting a sentence. The JSON structure and all other fields (`id`, `question`, `choices`, `answer`,`causal_chain`,`correctness`) must remain **unchanged**.
